...
const PromptSchema = Yup.object().shape({
    ...
    prompt: Yup.string().min(50, "¡Demasiado corto!").required("Describir el entrenamiento para la Inteligencia Artificial"),
    voice: Yup.string().required("Establezca el modo en Voz"),
    max_tokens: Yup.number().required("Introduzca el número máximo de tokens"),
    temperature: Yup.number().required("Reportar la temperatura"),
