    ...
    <MainContainer>
      ...
      <Paper className={classes.redBox} variant="outlined">
        <Typography variant="body1">
          <strong>Aviso importante:</strong> Para todos los usuarios de Whaticket que han notado una interrupción en el funcionamiento de OpenAI, nos gustaría aclarar que esto no es un error del sistema. OpenAI ofrece un crédito gratuito de $5 USD para nuevos registros, sin embargo, este beneficio también está sujeto a un límite de tiempo, generalmente alrededor de tres meses. Cuando se acabe el crédito disponible, deberás recargar tu cuenta para continuar utilizando el servicio. Es importante tener en cuenta esta política para garantizar una experiencia fluida e ininterrumpida al utilizar OpenAI con Whaticket. Si notas que el servicio ha dejado de funcionar, verifica si tu crédito gratuito ha expirado y considera recargar tu cuenta si es necesario. Estamos disponibles para ayudar y aclarar cualquier duda adicional que pueda surgir. Gracias por su comprensión y seguiremos trabajando para brindar el mejor servicio posible a nuestros usuarios.
        </Typography>
        {/* Links úteis */}
        <Typography variant="body1">
