...
contacts: {
  ...
  confirmationModal:{
			...
			importMessage: "Esta acción importará los contactos guardados en la libreta de direcciones de WhatsApp. ¡Algunos modelos pueden no permitir esta funcionalidad o según su configuración de privacidad! Compruebe el resultado en 1 hora.",
			deleteTitle:"Borrar",
...
transferTicketModal: {
  ...
  messageOptionsMenu: {
    delete: "Eliminar",
	reactionSuccess: "Añadir reacción",
    reply: "Responder",
	edit: 'Editar mensaje',
		forward: "Para reenviar",
        toForward: "Para reenviar",
		react: "Reaccionar",
    confirmationModal: {
